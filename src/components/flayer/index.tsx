		...
		<div className="w-[90%] m-auto mt-4">
			...
			<div className="flex gap-4 h-[488px] mt-4">
				<div className="w-[287px] bg-[#f5f5f5] rounded-sm flex flex-col gap-2 items-start ">
					...
					<Button variant={"link"}>O'quv Adabiyoti</Button>
					<Button variant={"link"}>Diniy Adabiyoti</Button>
					<Button variant={"link"}>Ilmiy Omabob</Button>
					<Button variant={"link"}>Psilxologiya</Button>
				...
				<div className="w-full rounded-sm flex justify-end">
					<Carousel className="w-[95%] bg-red-500">
						<CarouselContent>
							<CarouselItem>
								<img
									alt="random-img"
